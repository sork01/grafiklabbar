...
// *neode.command* setgo gcc -O3 -I./glm -I/usr/include/SDL -lstdc++ -lm -lSDL lab3final.cpp -o lab3final; ./lab3final
#include <iostream>
#include <glm/glm.hpp>
#include <SDL.h>
...
vec3 indirectLightPowerPerArea = 0.25f * vec3(1, 1, 1);
...
void Draw()
{
    ...
    for (int i=0; i<triangles.size(); ++i)
    {
        ...
        // render a dot to show where the light is
...
void PixelShader(const Pixel& p, vec3 color)
{
    ...
    vec3 r = lightPos - (p.pos3d / p.zinv);
...
void InterpolateLine(const Pixel& a, const Pixel& b, vector<Pixel>& line)
{
    ...
    if (pixels > 5000) // fixme ugly hack
    {
        return;
    }
