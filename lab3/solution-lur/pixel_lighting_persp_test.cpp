...
// *neode.command* setgo gcc -O3 -I./glm -I/usr/include/SDL -lstdc++ -lm -lSDL pixel_lighting_persp_test.cpp -o pixel_lighting_persp_test; ./pixel_lighting_persp_test
#include <iostream>
#include <glm/glm.hpp>
#include <SDL.h>
...
int main(int argc, char* argv[])
{
    ...
    // LoadOBJModel("/home/lur/obj/cornellbox.obj", triangles, 1.0f, true);
